    ...
    <main class="container">
        ...
        <div class="product-list">
            <div class="product-card">
                <a href="detail.jsp?tradeNo=1">
                    <img src="../resources/img/식기.jpg" alt="식기세척기">
                </a>
                <div class="product-title">${trade.tradeTitle}식기세척기</div>
                <div class="product-price">${trade.tradePrice}가격 65,000</div>
            </div>
            <div class="product-card">
                <a href="detail.jsp?tradeNo=2">
