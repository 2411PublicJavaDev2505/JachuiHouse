...
<title>공지사항 - 수정</title>
    ...
    <main class="main">
		<div id="notice-div">
            ...
            <div id="add">
                <h2 id="notice-detail">공지사항 수정</h2>
                <hr>
            </div>
                <div class="">
                	<label>공지 종류</label>
                ...
                제목   <input type="text" id="" name="noticeTitle"  value="${noticeVO.noticeTitle }">
                ...
                <div id="noticeContent-detail">
                    <textarea id="real-product-detail" name="noticeContent" rows="10" cols="120"   value="${noticeVO.noticeContent }"></textarea>
                </div>
