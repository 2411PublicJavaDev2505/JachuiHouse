	       		...
	       		<div class="pagination-container">
					<div class="pagination">
						<c:if test="${startNavi ne 1 }">
							<a href="/notice/search?page=${startNavi - 1 }&searchKeyword=${searchKeyword}" class="prev">&lt;</a>
						</c:if>
						<c:forEach begin="${startNavi }" end="${endNavi }" var="p">
							<a href="/notice/search?page=${p }&searchKeyword=${searchKeyword}">${p }</a>
						</c:forEach>
						<c:if test="${endNavi ne maxPage }">
							<a href="/notice/search?page=${endNavi + 1 }&searchKeyword=${searchKeyword}" class="next">&gt;</a>
						</c:if>
					</div>        	
		        </div>
